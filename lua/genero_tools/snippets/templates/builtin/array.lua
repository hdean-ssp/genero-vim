...
return {
  {
    ...
    body = [[
DEFINE ${1:array_name} ARRAY[${2:size}] OF ${3:element_type}
    ]],
  },
  {
    trigger = "arrd",
    ...
    body = [[
DEFINE ${1:array_name} DYNAMIC ARRAY OF ${2:element_type}
    ]],
  },
  {
    trigger = "arri",
    ...
    body = [[
DEFINE ${1:array_name} ARRAY[${2:size}] OF INT
    ]],
  },
  {
    trigger = "arrs",
    ...
    body = [[
DEFINE ${1:array_name} ARRAY[${2:size}] OF STRING
    ]],
  },
  {
    trigger = "arrr",
    ...
    body = [[
DEFINE ${1:array_name} ARRAY[${2:size}] OF ${3:record_type}
    ]],
  },
  {
    trigger = "arrm",
    ...
    body = [[
DEFINE ${1:array_name} ARRAY[${2:rows}][${3:cols}] OF ${4:element_type}
    ]],
  },
}
