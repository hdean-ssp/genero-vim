...
function! genero_tools#config#init() abort
  ...
  call genero_tools#config#init_key('snippet_list_selectable', 1)
  call genero_tools#config#init_key('autocomplete_include_snippets', 1)
  call genero_tools#config#init_key('snippet_expansion_mode', 'luasnip')
