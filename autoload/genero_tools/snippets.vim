...
function! genero_tools#snippets#list() abort
  ...
  try
    ...
    call genero_tools#error#log('Error listing snippets: ' . v:exception)
  endtry
endfunction
...
function! genero_tools#snippets#help(trigger) abort
  ...
  if empty(a:trigger)
    call genero_tools#error#log('Please specify a snippet trigger')
    return
  endif
  ...
  try
    ...
    call genero_tools#error#log('Error showing snippet help: ' . v:exception)
  endtry
endfunction
...
function! genero_tools#snippets#expand(trigger) abort
  ...
  try
    ...
    call genero_tools#error#log('Error expanding snippet: ' . v:exception)
  endtry
endfunction
