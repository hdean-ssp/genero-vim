# Bug Fixes Summary - March 23, 2026

## Overview
Fixed 4 critical bugs affecting snippet autocomplete, debug stream selection, floating window display, and message routing.
...
- [ ] Select snippet from menu
- [ ] Verify snippet expands with placeholders
- [ ] Verify placeholder navigation works (Tab/Shift+Tab)
...
1. Test all fixes with real-world usage
2. Monitor for any edge cases
3. Update documentation if needed
4. Consider adding more keyboard shortcuts for debug stream selection
5. Consider adding search/filter for debug stream file list
