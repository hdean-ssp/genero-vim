" Full test script for Ctrl+N autocomplete keybinding
...
try
  ...
  call RecordTest('Plugin initialization', 1, 'Plugin loaded successfully')
catch
  call RecordTest('Plugin initialization', 0, 'Exception: ' . v:exception)
endtry
